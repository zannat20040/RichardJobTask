...
const Footer = () => {
    return (
        ...
        <div className="footer-top section" id="contact">
          <div className="container">
            ...
            <a href="#" className="btn-icon" data-reveal>
              <img src={arrowfrw} width="43" height="20" loading="lazy" alt="arrow-forward icon" />
            </a>
    
            <img src={footer1} width="159" height="176" loading="lazy" alt="photography"
              className="abs-img abs-img-1" data-reveal />
    
            <img src={footer2} width="265" height="275" loading="lazy" alt="photography"
              className="abs-img abs-img-2" data-reveal />
    
            <img src={footer3} width="303" height="272" loading="lazy" alt="photography"
              className="abs-img abs-img-3" data-reveal />
    
            <img src={footer4} width="175" height="175" loading="lazy" alt="photography"
              className="abs-img abs-img-4" data-reveal />
    
            <img src={shape} width="185" height="134" loading="lazy" alt="" className="shape" />
        ...
        <div className="footer-bg has-before">
          <img src={bg} width="1920" height="1135" loading="lazy" alt="photography"
            className="img-cover" />
        </div>
